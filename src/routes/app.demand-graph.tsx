...
export const Route = createFileRoute("/app/demand-graph")({
  head: () => ({
    meta: [
      { title: "Demand Graph · Newintel workspace" },
      {
        name: "description",
        content:
  ...
  return (
    <div>
      ...
      <PageHeader
        ...
        title="Follow the event, not the inventory"
        intro="The graph maps how companies connect: customers, suppliers, partners, projects, industries, related assets. An event anywhere on it, a data-center expansion, a capacity guide, a contract, travels along those edges until it reaches the companies you can supply. Each edge carries timing, confidence and evidence."
      >
                ...
                <div>
                  ...
                  >
                    ...
                    <span className="app-graph-node-copy">
                      The node Newintel is watching for meaningful change.
                    </span>
                  </button>
                </div>
              ...
              <>
                ...
                <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                  {EVENT_MEANING[selection.value] ??
                    "This event moves something the watched supply is exposed to, through the chain above."}
                </p>
        ...
        <div className="mt-8 grid gap-5 border-t border-border pt-6 sm:grid-cols-3">
          <div className="flex gap-3">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              Click an event to see how it reaches the companies exposed to it.
            </p>
          </div>
          <div className="flex gap-3">
            <CircleHelp className="size-4 shrink-0 text-signal" aria-hidden />
            <p className="text-sm leading-relaxed text-muted-foreground">
              Click an exposure to see the evidence and supply entries behind it.
            </p>
          </div>
          <div className="flex gap-3">
            <CircleHelp className="size-4 shrink-0 text-signal" aria-hidden />
