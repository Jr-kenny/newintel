...
function Brand({ compact = false }: { compact?: boolean }) {
  return (
    <span className={`app-brand ${compact ? "app-brand-compact" : ""}`}>
      ...
      <span>
        <span className="app-brand-name">Newintel</span>
  ...
  return (
    <div className="app-shell">
      <aside className="app-rail">
        <div>
          <Link to="/" className="app-rail-brand" aria-label="Newintel: back to the city">
            <Brand />
          </Link>
      ...
      <div className="app-main-column">
        <header className="app-mobile-header">
          <Link to="/" aria-label="Newintel: back to the city">
            <Brand compact />
          </Link>
          <button
            type="button"
