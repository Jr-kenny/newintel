...
const pricedInLabel: Record<string, string> = {
  underpriced: "Window still open",
  priced: "Window likely closing",
  overpriced: "Window may already be closed",
  unclear: "Timing too mixed to call",
};
...
export function ReportView({ report }: { report: IntelligenceReport }) {
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500">
      ...
      {/* 3 — Timing implication across horizons. */}
      <section className="surface-dark p-6 sm:p-8" aria-label="Timing implication">
        <p className="label-mono text-signal">Timing implication</p>
