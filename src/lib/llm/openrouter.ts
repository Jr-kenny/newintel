/**
 * OpenRouter fallback provider. Set OPENROUTER_API_KEY to enable.
 * Default is a free model — this key has no credits. Override with OPENROUTER_MODEL.
 */
  ...
  try {
    const res = await fetch("https://openrouter.ai/api/v1/chat/completions", {
      ...
      headers: {
        ...
        "HTTP-Referer": "https://newintel.app",
        "X-Title": "Newintel",
      },
      body: JSON.stringify({
        model: config.model,
